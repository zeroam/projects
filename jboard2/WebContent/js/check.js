$(function() {
	...
	$('input[name=id]').focusout(function(){
		...
		*/
		...
		$.ajax({
			url:'/jboard2/member/checkUser.do?check=uid&value='+value,
			type:'get',
			dataType:'json',
	...
	$('input[name=nick]').focusout(function(){
		...
		var value = tag.val();
		$.ajax({
			url:'/jboard2/member/checkUser.do?check=nick&value='+value,
			type:'get',
			dataType:'json',
			success: function(data){
				if(value === "") {
	...
	$('input[name=email]').focusout(function(){
		...
		var value = tag.val();
		$.ajax({
			url:'/jboard2/member/checkUser.do?check=email&value='+value,
			type:'get',
			dataType:'json',
			success: function(data){
				if(value === "") {
	...
	$('input[name=hp]').focusout(function(){
		...
		var value = tag.val();
		$.ajax({
			url:'/jboard2/member/checkUser.do?check=hp&value='+value,
			type:'get',
			dataType:'json',
			success: function(data){
				if(value === "") {
